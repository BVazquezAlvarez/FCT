  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        ...
        <input type='text' maxlength='20' class='form-control' id='inputid' placeholder='ID' disabled='true' required>
      </div>
      ...
      <div class='form-group col-md-5'>
        ...
        <input type='text'  class='form-control' id='inputname' placeholder='Nombre.' disabled='true' required>
      </div>
      <div class='form-group col-md-6'>
        <label for='inputapellidos'>Apellidos</label>
        <input type='date' maxlength='20' class='form-control' id='inputapellidos' placeholder='Apellidos' required>
      </div>
      </div>
      <div class='row'>
      <div class='form-group col-md-5'>
        <label for='inputdni'>Correo</label>
        <input type='email' maxlength='30' class='form-control' id='inputcorreo' placeholder='Correo' required>
      </div> 
      ...
      <div class='form-group col-md-4'>
        ...
        <input type='text' maxlength='20' class='form-control' id='inputdni' placeholder='DNI' required>
      </div> 
      </div>
      <div class='row'>
       <div class='form-group col-md-7'>
        <label for='inputdireccion'>Direccion</label>
        <input type='text'maxlength='60'  class='form-control' id='inputdireccion' placeholder='Direccion' required>
      </div>
      <div class='form-group col-md-5'>
        <label for='inputpoblacion'>Poblacion</label>
        <input type='text' maxlength='45' class='form-control' id='inputpoblacion' placeholder='Poblacion' required>
      </div>
      </div>
      <div class='row'>
      <div class='form-group col-md-5'>
        <label for='inputfechaalta'>Fecha alta</label>
        <input type='text' maxlength='20' class='form-control' id='inputfechaalta' placeholder='Fecha alta' required>
      </div>
      <div class='form-group col-md-5'>
      ...
      <div class='form-group col-md-3'>
        ...
        <input type='text' maxlength='20' class='form-control' id='inputcodigopostal' placeholder='Cod. Postal' required>
      </div>
      <div class='form-group col-md-6'>
        <label for='inputprovincia'>Provincia</label>
        <input type='text' maxlength='45' class='form-control' id='inputprovincia' placeholder='Provincia' required>
      </div>
      </div>
      <div class='row'>
      <div class='form-group col-md-4'>
        <label for='inputfechanac'>Fecha Nac</label>
        <input type='text' maxlength='20' class='form-control' id='inputfechanac' placeholder='Fecha Nac.' required>
      </div>
      <div class='form-group col-md-2'>
        <label for='inputactivo'>Activo</label>
        <select  name='inputactivo' id='inputactivo' class ='form-control' required>
      ...
      <div class='modal-footer'>
        ...
        <input type='submit' class='btn btn-primary' id='guardarform'></button>
      </div>
       </form>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
